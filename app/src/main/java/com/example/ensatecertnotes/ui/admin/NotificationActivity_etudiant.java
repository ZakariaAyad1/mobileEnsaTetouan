...
import com.example.ensatecertnotes.utils.SessionManager; // salma
...
public class NotificationActivity_etudiant extends AppCompatActivity {
    ...
    private int userId;
    private boolean isStudent = false; // salma
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*salma*/
        isStudent = getIntent().getBooleanExtra("IS_STUDENT", false);
    ...
    private void loadNotifications() {
        ...
        if (notificationList.isEmpty()) {
            ...
            NotificationAdapter_etudiant adapter = new NotificationAdapter_etudiant(this, notificationList, isStudent); // salma: pass isStudent
