...
public class SessionManager {
    ...
    public static final String KEY_ETUDIANT_ID = "etudiantId";
    /*salma*/
    ...
    /*salma*/
    public void createLoginSession(int userId, String role, String userName, int etudiantId) {
        editor.putBoolean(IS_LOGIN, true);
        editor.putInt(KEY_USER_ID, userId);
        editor.putString(KEY_ROLE, role);
        editor.putString(KEY_USER_NAME, userName);
        editor.putInt(KEY_ETUDIANT_ID, etudiantId);
        editor.commit();
    }
    /*salma*/
    ...
    public int getEtudiantId() {
        return pref.getInt(KEY_ETUDIANT_ID, -1);
    }
    /*salma*/
